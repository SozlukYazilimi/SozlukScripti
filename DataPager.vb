...
'            Dim retValue = String.Empty
'            Dim link = String.Format("<li><a href=""{0}"">{{1}}</a></li>", PageUrl())
'            Const LinkCurrent As String = "<li class=""active""><span>{0}</span></li>"
'            Dim linkFirst = String.Format("<li><a href=""{0}"">{{0}}</a></li>", PageUrl()) 'lasyaf yosarak
'            Const LinkDisabled As String = "<li><a href=""#"">{0}</a></li>"
...
'            If postCnt > 0 AndAlso pagesTotal > 1 Then
'                retValue = "<ul id=""paginationUL"" class=""sayfalama"">"

'                If currentPage = 1 Then
'                    retValue += String.Format(LinkDisabled, "&lt")
'                Else
'                    retValue += String.Format(link, currentPage - 1, "&lt")
'                End If
...
'                If currentPage = pagesTotal Then
'                    retValue += String.Format(LinkDisabled, "&gt")
'                Else
'                    retValue += String.Format(link, currentPage + 1, "&gt")
'                End If
